...
public class WeChatReturnCode {
     ...
     * 全局返回码说明
     */
    private final static Map<Integer, String> returnCodeMap = new HashMap<>();

    static {
        returnCodeMap.put(-1, "系统繁忙，此时请开发者稍候再试");
        returnCodeMap.put(0, "请求成功");
        returnCodeMap.put(40001, "获取access_token时AppSecret错误，或者access_token无效。请管理员认真比对AppSecret的正确性，或查看是否正在为恰当的公众号调用接口");
        ...
        returnCodeMap.put(40059, "不合法的msgId");
        ...
        returnCodeMap.put(41008, "缺少aouthcode");
        ...
        returnCodeMap.put(48003, "没有群发权限");
