...
public class ScheduleJob {
    ...
    public static String STATUS_RUNNING = "1";  //正在运行
    public static String STATUS_NOT_RUNNING = "0"; // 已停止
    public static String CONCURRENT_IS = "1";
    public static String CONCURRENT_NOT = "0";
    ...
    public String toString() {
        return "ScheduleJob [jobId=" + jobId + ", jobName=" + jobName + ", jobGroup=" + jobGroup + ", jobStatus="
                ...
                + beanClass + ", isConcurrent=" + isConcurrent + ", springId=" + springId + ", jobData=" + jobData
                + "]";
    }
